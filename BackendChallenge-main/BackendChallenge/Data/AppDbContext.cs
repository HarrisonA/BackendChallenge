...
public class AppDbContext : DbContext
{
    ...
    public void SeedData(ModelBuilder modelBuilder)
    {
        ...
        /* Added values for new properties (details in the README:
          `LearningItemName` and `ItemId`
          that are required by the get learning-plan endpoint
        */
